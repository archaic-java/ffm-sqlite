...
Current slice supports one prepared SQL statement at a time, scalar and byte-array bindings, forward stepping, and transaction rollback. The catalog contains the executable provider conformance check. Backup, checkpoints, cancellation, streaming BLOBs, and temporal helpers remain for later slices.
